...
### ΔΕΔΟΜΕΝΑ ΚΑΙ ΕΠΕΞΕΡΓΑΣΙΑ ΔΕΔΟΜΕΝΩΝ
Τα δεδομένα της παρούσας μελέτης προέρχονται από το Earth Microbiome Project (EMP) και συγκεκριμένα από τον δημοσιευμένο πίνακα αφθονιών των Amplicon Sequence Variants (ASVs) και τα συνοδευτικά μεταδεδομένα (metadata), τα οποία διατέθηκαν στο πλαίσιο της εργασίας των Thompson et al. (2017). Το EMP αποτελεί μία από τις μεγαλύτερες παγκόσμιες πρωτοβουλίες για την καταγραφή της μικροβιακής ποικιλότητας, παρέχοντας ομογενοποιημένα δεδομένα από χιλιάδες περιβαλλοντικά δείγματα που έχουν αναλυθεί με κοινό πρωτόκολλο αλληλούχισης και βιοπληροφορικής επεξεργασίας (Thompson et al., 2017).
Ο πίνακας αφθονιών ήταν διαθέσιμος σε μορφή BIOM και περιλάμβανε ήδη την ταξινομική ανάθεση των ASVs, γεγονός που κατέστησε περιττή την εκ νέου ταξινομική ταξινόμηση των αλληλουχιών. Από το σύνολο των δειγμάτων επιλέχθηκαν αποκλειστικά τα εδαφικά μικροβιώματα (soil microbiomes), καθώς στόχος της εργασίας είναι η διερεύνηση των προτύπων διαφοροποίησης της μικροβιακής ποικιλότητας σε εδαφικές κοινότητες.


Στη συνέχεια, τα μεταδεδομένα εισήχθησαν στο περιβάλλον της R και κάθε δείγμα αντιστοιχίστηκε σε κλιματική ζώνη σύμφωνα με την ταξινόμηση Köppen-Geiger, χρησιμοποιώντας το υπολογιστικό pipeline που περιγράφεται από τους Pechlivanis et al. (2024). Η προσέγγιση αυτή επιτρέπει την ομοιόμορφη ταξινόμηση των δειγμάτων σε κλιματικές ζώνες και έχει χρησιμοποιηθεί επιτυχώς για την ανάλυση παγκόσμιων προτύπων μικροβιακής ποικιλότητας και δικτύων συνύπαρξης εδαφικών μικροοργανισμών.


Μετά την κλιματική ταξινόμηση, επιλέχθηκε αποκλειστικά η εύκρατη (temperate) κλιματική ζώνη, καθώς παρουσίαζε την πληρέστερη και πιο ισορροπημένη εκπροσώπηση των βιοτόπων που εξετάζονται στην παρούσα εργασία, δηλαδή των anthropogenic terrestrial biome, forest biome, grassland biome και shrubland biome. Αντίθετα, οι κλιματικές ζώνες με περιορισμένη αντιπροσώπευση συγκεκριμένων βιοτόπων αποκλείστηκαν, ώστε να μειωθεί η επίδραση της άνισης δειγματοληψίας στις συγκρίσεις μεταξύ οικοσυστημάτων. Επιπλέον, από τα δείγματα της εύκρατης ζώνης αποκλείστηκαν τα desert biome και tundra biome, καθώς δεν είχαν καλή εκπροσώπηση στις υπόλοιπες ζώνες.


Από την κατηγορία anthropogenic terrestrial biome εξαιρέθηκαν επίσης όλα τα δείγματα που αντιστοιχούσαν σε καλλιεργούμενες εκτάσεις (croplands). Η απόφαση αυτή βασίστηκε σε δύο κύριους λόγους. Πρώτον, οι καλλιέργειες που περιλαμβάνονταν στο EMP παρουσίαζαν μεγάλη ετερογένεια ως προς τον τύπο της καλλιέργειας και τις γεωργικές πρακτικές (π.χ. σιτηρά, τροπικές δενδρώδεις καλλιέργειες και άλλες γεωργικές χρήσεις), γεγονός που εισάγει σημαντική περιβαλλοντική μεταβλητότητα ανεξάρτητη από τον κύριο στόχο της μελέτης. Δεύτερον, τα αγροτικά εδάφη έχουν ήδη αποτελέσει αντικείμενο εκτεταμένης διερεύνησης με τα δεδομένα του Earth Microbiome Project, τόσο όσον αφορά τη σύνθεση των μικροβιακών κοινοτήτων όσο και τους οικολογικούς μηχανισμούς που τις διαμορφώνουν.


Η παρούσα εργασία επικεντρώνεται στη σύγκριση της μικροβιακής ποικιλότητας μεταξύ φυσικών και αστικών εδαφικών οικοσυστημάτων της εύκρατης ζώνης, συνδυάζοντας στοιχεία από προηγούμενες παγκόσμιες αναλύσεις της εδαφικής μικροβιακής βιοποικιλότητας. Τα τελευταία χρόνια, πλήθος μελετών που βασίζονται στα δεδομένα του Earth Microbiome Project έχουν εξετάσει ζητήματα όπως η επίδραση του κλίματος και της γεωγραφικής απόστασης στη σύσταση των μικροβιακών κοινοτήτων, οι στοχαστικοί και ντετερμινιστικοί μηχανισμοί συναρμολόγησης των κοινοτήτων, η ομαδοποίηση των εδαφικών δειγμάτων ανά habitat, οι οικολογικές προτιμήσεις των προκαρυωτικών, το φαινόμενο «diversity begets diversity», οι διαφορές στην άλφα-, βήτα- και γάμα-ποικιλότητα μεταξύ διαφορετικών οικοσυστημάτων, καθώς και η δημιουργία παγκόσμιων δικτύων συνύπαρξης μικροοργανισμών και η επίδραση της χωρικής κλίμακας στην κατανομή της εδαφικής βακτηριακής ποικιλότητας.


Μετά την εφαρμογή όλων των παραπάνω κριτηρίων επιλογής, το τελικό σύνολο δεδομένων περιλάμβανε 83 δείγματα από δασικά οικοσυστήματα (forest biome), 16 από λιβαδικά οικοσυστήματα (grassland biome), 31 από θαμνώδη οικοσυστήματα (shrubland biome) και 145 δείγματα από ανθρωπογενή οικοσυστήματα (anthropogenic terrestrial biome). Ωστόσο, πρέπει να επισημανθεί ότι όλα τα δείγματα του ανθρωπογενούς βιοτόπου προέρχονται από μία μόνο δημοσιευμένη μελέτη και συγκεκριμένα από αστικά εδάφη της Νέας Υόρκης. Η ιδιαιτερότητα αυτή δημιουργεί σημαντική ανισορροπία τόσο ως προς το μέγεθος των ομάδων όσο και ως προς τη γεωγραφική τους προέλευση. 
...
Pechlivanis, N., Karakatsoulis, G., Kyritsis, K. et al. 

Microbial co-occurrence network demonstrates spatial and climatic trends for global soil diversity. Sci Data 11, 672 (2024). https://doi.org/10.1038/s41597-024-03528-1
